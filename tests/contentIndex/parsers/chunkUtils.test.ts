 ...
 * npx tsc -p tests/tsconfig.json; node --test out-test/tests/contentIndex/parsers/chunkUtils.test.js
 */
...
import {
    ...
    MIN_CHUNK_CHARS,
    MAX_LINE_LENGTH,
} from '../../../src/contentIndex/parsers/chunkUtils';
import type { ChunkRange } from '../../../src/contentIndex/parsers/chunkUtils';
